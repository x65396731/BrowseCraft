...
struct VideoRuntimeEvidenceFingerprint: RawRepresentable, Codable, Hashable, Sendable {
    let rawValue: String
...
struct VideoRuntimeEvidenceRejectionReason: RawRepresentable, Codable, Hashable, Sendable {
    let rawValue: String
...
enum VideoRuntimeAuditCatalogInputError: Error, Equatable {
    case emptyCatalog
...
struct VideoRuntimeAuditCatalogInput: Sendable {
    let rawCatalogData: Data
    let catalogSHA256: VideoRuntimeEvidenceFingerprint

    init(rawCatalogData: Data) throws {
...
enum VideoRuntimeEvidenceFingerprintError: Error, Equatable {
    case emptyIdentityComponent(String)
    case invalidResourceURL
    case invalidGroupIndex
}

enum VideoRuntimeEvidenceFingerprintFactory {
    static func detailSample(
    ...
    static func groupOwnerID(pageID: String, groupIndex: Int) throws -> String {
