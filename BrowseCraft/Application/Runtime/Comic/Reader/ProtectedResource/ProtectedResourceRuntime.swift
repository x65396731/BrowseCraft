...
struct ProtectedResourceLoader {
    ...
    private func deriveKeyEnvelope(
        ...
        guard let envelopePath: String,
              let encryptedEnvelope: String = ComicRuleJSONResolver.stringValue(
                ComicRuleJSONResolver.firstJSONValue(at: envelopePath, in: keyResponse)
              ),
...
enum ProtectedResourceValueResolver {
    ...
    static func stringValue(
        ...
        case .keyResponse:
            ...
            rawValue = ComicRuleJSONResolver.stringValue(
                ComicRuleJSONResolver.firstJSONValue(at: path, in: keyResponse)
            )
        case .parameter:
