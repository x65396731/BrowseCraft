...
public enum CookieHeaderResolver: Sendable {
    public static func headersByApplyingPageCookies(
    ...
    public static func headersByApplyingImageCookies(
        to headers: [String: String],
        url: URL,
        request: RequestConfig?,
        browserCookieHeader: String?,
    ...
    public static func headersByApplyingCookies(
        to headers: [String: String],
        url: URL,
    ...
    public static func resolvedCookieHeader(
        cookiePolicy: CookiePolicy?,
        cookiePriority: CookiePriority?,
