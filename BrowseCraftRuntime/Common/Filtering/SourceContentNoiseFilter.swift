...
public enum SourceContentNoiseContext: String, Hashable, Sendable {
    case listItem
    case navigationLink
...
public enum SourceContentPlaybackAssurance: String, Hashable, Sendable {
    case inferred
    case ruleDeclared
}

public enum SourceContentNoiseAction: String, Hashable, Sendable {
    case keep
    case discard
    case deprioritize
}

public enum SourceContentNoiseReason: String, Hashable, Sendable {
    case emptyContent
    case advertising
    case popupOrOverlay
    case tracking
...
public struct SourceContentNoiseCandidate: Hashable, Sendable {
    ...
    public var sourceKind: SourceRuntimeKind?
    public var playbackAssurance: SourceContentPlaybackAssurance
    public var context: SourceContentNoiseContext
...
public struct SourceContentNoiseDecision: Hashable, Sendable {
    public init(
        action: SourceContentNoiseAction,
        reasons: [SourceContentNoiseReason]
    ) {
        self.action = action
        self.reasons = reasons
    }

    public var action: SourceContentNoiseAction
    public var reasons: [SourceContentNoiseReason]

    public static let keep: SourceContentNoiseDecision = SourceContentNoiseDecision(
        action: .keep,
        reasons: []
    )
}

public protocol SourceContentNoiseFiltering: Sendable {
    func decision(for candidate: SourceContentNoiseCandidate) -> SourceContentNoiseDecision
}

public struct SourceContentNoiseFilter: SourceContentNoiseFiltering, Sendable {
    private let lexicon: SourceDetectionLexicon

    public init(lexicon: SourceDetectionLexicon = .default) {
        self.lexicon = lexicon
    }

    public func decision(for candidate: SourceContentNoiseCandidate) -> SourceContentNoiseDecision {
