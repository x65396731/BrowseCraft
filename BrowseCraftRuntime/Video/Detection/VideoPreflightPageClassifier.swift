...
public enum VideoPreflightPageClassification: Equatable, Sendable {
    case usableHTML
    case technicalShell
...
public struct VideoPreflightPageClassifier: Sendable {
    public init() {}

    public func classify(_ page: PreflightAcquiredPage) -> VideoPreflightPageClassification {
