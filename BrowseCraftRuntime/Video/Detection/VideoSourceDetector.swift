...
public struct VideoSourceDetector: VideoSourceDetecting, Sendable {
    private let lexicon: VideoDetectionLexicon

    public init(lexicon: VideoDetectionLexicon = .default) {
        self.lexicon = lexicon
    }

    public func detect(_ input: VideoSourceDetectionInput) -> VideoSourceDetection {
...
private struct DetectionScore {
    public var score: Double
    public var reasons: [String]
    public var hasStructuredCMSMarkers: Bool
}

private struct PlaybackDetection {
    public var mode: VideoPlaybackMode
    public var reasons: [String]
}

private struct RestrictionSignal {
    public var score: Double
    public var shouldUsePlugin: Bool
    public var reasons: [String]
}
...
private struct VideoSourceSignals {
    ...
    public init(input: VideoSourceDetectionInput) {
    ...
    public var htmlIsEmptyShell: Bool {
    ...
    public var hasUnmappedWebViewShell: Bool {
        return self.hasAppShell && self.hasMappableVideoContent == false
    }
    ...
    public var videoRouteHitCount: Int {
        let patterns: [String] = [
            #"/video"#,
            #"/watch"#,
            #"/play"#,
