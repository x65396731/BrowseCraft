...
public struct VideoSourceRuntime: SourceRuntime, SourceDetailRuntime, SourceVideoPlaybackRuntime, Sendable {
    public let source: Source
    public let resolvedRule: ResolvedVideoSiteRule
    ...
    public func loadPlayback(_ input: SourceVideoPlaybackInput) async throws -> SourceVideoPlaybackOutput {
        try self.validateSource(input.context)
    ...
    public func auditPlaybackWithRouteFacts(
