...
public struct VideoRulePaginationResolution: Sendable {
    public init(
        currentPage: Int,
        configuredPageURL: URL,
        nextPage: SourcePagination?,
        stopWhenEmpty: Bool?
    ) {
        self.currentPage = currentPage
        self.configuredPageURL = configuredPageURL
        self.nextPage = nextPage
        self.stopWhenEmpty = stopWhenEmpty
    }

    public let currentPage: Int
    public let configuredPageURL: URL
    public let nextPage: SourcePagination?
    public let stopWhenEmpty: Bool?
}

public struct VideoRulePaginationResolver: Sendable {
    public init() {}
