...
public enum VideoRuleAPITemplateResolverError: LocalizedError, Sendable {
...
public struct VideoRuleAPITemplateContext: Sendable {
    public let source: Source
    public let rule: VideoSiteRule
    public let itemReference: SourceItemReference?
    public let detailURL: URL?
    public let credentialProvider: any SourceCredentialProviding
...
public struct VideoRuleAPITemplateResolver: Sendable {
    public init() {}

    public static func resolvedContextValues(
        source: Source,
        rule: VideoSiteRule,
        credentialProvider: any SourceCredentialProviding
    ) -> [String: String] {
    ...
    public static func resolvedRequest(
