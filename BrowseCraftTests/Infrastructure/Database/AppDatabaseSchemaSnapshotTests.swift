...
struct AppDatabaseSchemaSnapshotTests {
    ...
    // （SQLite 的 ALTER TABLE ADD COLUMN 把新列插在列定义末尾、表约束之前）与 v3.local-books（三张表、三个索引）、v4.book-progress-detached-from-local-books（进度与书签两张表重建、去掉对 local_books 的外键）、v5.book-reading-history（站点书阅读历史一张表、一个索引）。
